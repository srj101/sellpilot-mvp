...
export function CustomerDetailClient({ customer }: { customer: CustomerDetail }) {
  ...
  return (
    <div>
      {/* Back Button + Header */}
      <div className="mb-6">
        <Link href={`/${businessSlug}/dashboard/customers`} className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors mb-4">
