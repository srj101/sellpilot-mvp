  ...
  return (
    <div className="bg-card/80 text-card-foreground w-full max-w-md rounded-2xl border p-8 shadow-xl backdrop-blur-xl">
      <div className="mb-6 text-center">
        <h1 className="mb-2 text-3xl font-bold tracking-tight">SellPilot AI</h1>
        <p className="text-muted-foreground text-sm leading-relaxed">
          Integrate Instagram, WhatsApp, Facebook and auto-reply from the help
          of the database and Intelligent model.
        </p>
      </div>
